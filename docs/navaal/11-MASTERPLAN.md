...
| | **Status 2026-09-15:** layer live `1d9d8f7` (D0); **de live `a9ffd38`** (D1, 1,365 keys, read back on production); **fr live `86b417c`** (D2, read back on production); es, it, pt-BR, ja not yet — `?locale=es` renders English by design until its catalogue is complete. | |
...
| C3 | Listing in six languages | **German (`a9ffd38`) and French (`86b417c`): gates met — CW enters them now.** es, it, pt-BR, ja gated on B2 per locale | CW |

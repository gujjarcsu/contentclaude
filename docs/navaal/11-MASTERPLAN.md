...
| | **Status 2026-09-15:** layer live `1d9d8f7` (D0); **de live `a9ffd38`** (D1, 1,365 keys, read back on production); fr, es, it, pt-BR, ja not yet — `?locale=fr` renders English by design until its catalogue is complete. | |
...
| C3 | Listing in six languages | **German: gate met at `a9ffd38` — CW enters it now.** fr, es, it, pt-BR, ja gated on B2 per locale | CW |

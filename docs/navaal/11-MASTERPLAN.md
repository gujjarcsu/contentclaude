...
| P0.7 | CW | **Remove "Dedicated account manager" and "SLA support" from the live listing**, and audit it for **"llms.txt"** and **"instant indexing"** — both now banned by doctrine and both currently sold in `04-DECISIONS.md`'s table. | immediately |
...
| ID | Owner | Item |
|---|---|---|
| P4.0 | OWNER + COWORK | **Re-decide the table**, informed by `B0.3` — ten merchants telling us beats a spreadsheet guessing. Lock it with the reasoning. |

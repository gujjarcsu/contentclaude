...
*Eleven false-green shapes so far: the ESLint `--cache`, twelve identical 410 screenshots, a CI guard
...
hardcoded copy shipped the wrong value to Shopify. The full list, with the rule each one produced, is
`07-VERIFICATION.md`.*
